...
function showRating(name, id) {
	var rating = {bookmark: [4.0, 5], calculator: [4.0, 4],
		countdown: [4.5, 23], dateentry: [4.0, 7],
		datepick: [5.0, 31], gchart: [4.0, 17],
		gsblogbar: [0.0, 0], gsbookbar: [0.0, 0],
		gsnewsbar: [0.0, 0], gsvideobar: [4.0, 1],
		icalendar: [4.5, 2], imagecube: [4.0, 8],
		keypad: [4.0, 5], labeleffect: [0.0, 0],
		localisation: [4.0, 2], realperson: [5.0, 1],
		relationships: [4.0, 1], svg: [4.0, 29],
		themes: [3.0, 1], timeentry: [4.0, 29]}[name];
	var html = '';
	if (rating) {
		html = ': <span>';
		for (var i = 0; i < 5; i++) {
